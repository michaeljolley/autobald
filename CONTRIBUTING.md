...
Add an [issue](https://github.com/builders-club/autobald/issues/new/choose). We'll review it, add labels and reply within a few days.
...
SSH
    ...
    git clone -b dev git@github.com:your-username/autobald.git
    git remote add upstream git@github.com:builders-code/autobald

HTTPS

    git clone -b dev https://github.com/your-username/autobald.git
    git remote add upstream https://github.com/builders-club/autobald

> **All changes should be based from the `dev` branch.**

Push to your fork and [submit a pull request](https://github.com/builders-club/autobald/compare/) against the `dev` branch.
...
- Name the extension something memorable to you. For example: `autobald-bot`
